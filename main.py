...
def empty_carts(name):
    ...
    channel.basic_publish(exchange='',
                        ...
                        body=name)
    print(" ✔️ Sent [ShoppingCart] Empty Shopping Cart")
    connection.close()
...
def execute_newman():
    completed = subprocess.Popen(["powershell", "-Command", ' newman run EC.postman_collection1.json --insecure '],shell=True,stdout=subprocess.PIPE)
